                ...
                <div class="card-body">
                    ...
                    <form action="{{route('maintenance.update',$maintenance->id)}}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="expenses" type="text" class="form-control{{ $errors->has('expenses') ? ' is-invalid' : '' }}" name="expenses" value="{{ $maintenance->expenses }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="amount" type="text" class="form-control{{ $errors->has('amount') ? ' is-invalid' : '' }}" name="amount" value="{{ $maintenance->amount }}" required>
